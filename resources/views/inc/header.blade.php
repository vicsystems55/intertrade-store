            ...
            <div class="header__topbar--inner d-flex align-items-center justify-content-between">
                <ul class="header__contact--info d-flex align-items-center">
                    <li class="header__contact--info__list text-white">
                        ...
                        <a href="tel:+8543553004">+234 805 767 4386</a>
                    </li>
                    <li class="header__contact--info__list text-white">
                        ...
                        <a href="mailto:demo@example.com">support@intertradeltd.biz</a>
                    </li>
                </ul>
                <div class="language__currency d-none d-lg-block">
                    <ul class="d-flex align-items-center">
                        <li class="language__currency--list d-none">
                            ...
                            <div class="dropdown__language d-none">
                                <ul>
                        ...
                        <li class="language__currency--list">
                            ...
                            <div class="dropdown__currency d-none">
                                <ul>
                ...
                <div class="header__account">
                    <ul class="d-flex">
                        ...
                        <li class="header__account--items">
                            <a class="header__account--btn" href="/dashboard">
                        ...
                        <li class="header__account--items">
                            <a class="header__account--btn minicart__open--btn" href="/cart" data-offcanvas>
                              ...
                              <cart-icon-component ref="CartIcon"  vueurl="{{config('app.ur')}}"></cart-icon-component>
                            </a>
                        </li>
                    </ul>
                </div>
