...
<main class="main__content_wrapper">
            ...
            <div class="hero__slider--activation swiper">
                <div class="hero__slider--wrapper swiper-wrapper">
                    <div class="swiper-slide ">
                        <div class="hero__slider--items home2__slider--items__bg one">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                    ...
                    <div class="swiper-slide ">
                        <div class="hero__slider--items home2__slider--items__bg two">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="slider__content style2">
    ...
    <section class="featured__product--section section--padding">
        <div class="container">
            <div class="row row-cols-lg-3 row-cols-1">
                        ...
                        <div class="featured__product--card mb-30">
                            <div class="featured__product--card__icon--img">
                                <span class="featured__product--card__icon">
                                    <img class="display-block" src="assets/img/icon/setting-icon.webp" alt="setting-icon">
                                </span>
                            </div>
                ...
                <div class="col col-md-order">
                    <div class="featured__product--thumbnail">
                        <img class="featured__product--thumbnail__img display-block" src="assets/img/product/featured-product.webp" alt="featured-img">
                    </div>
                </div>
                <div class="col">
                    <div class="featured__product--list">
            ...
            <div class="row row-cols-lg-2 row-cols-md-2 row-cols-1 align-items-center">
                <div class="col col-sm-order">
                    <div class="about__thumbnail">
                        <img class="display-block" src="assets/img/other/about-thumb2.webp" alt="about-thumb">
                    </div>
                </div>
                <div class="col">
                    <div class="about__content about__content--style2">
                        ...
                        <div class="about__content--step mb-25">
                            ...
                            <p class="about__content--desc style2 d-md-none">Beyond more stoic this along goodness this sed wow
                        ...
                        <div class="about__content--author d-flex align-items-center mb-50">
                            ...
                            <div class="about__content--author__text">
    ...
    <section class="product__section section--padding">
        <div class="container">
            <div class="section__heading text-center mb-50">
                <h2 class="section__heading--maintitle text__secondary mb-10">Our Featured Product</h2>
                ...
                <div class="row row-cols-lg-3 row-cols-md-3 row-cols-2 mb--n30">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                            <img class="product__card--thumbnail__img product__primary--img display-block" src="assets/img/product/product7.webp" alt="product-img">
                                            <img class="product__card--thumbnail__img product__secondary--img display-block" src="assets/img/product/product8.webp" alt="product-img">
                                        </a>
                    ...
                    <div class="col custom-col-2 mb-30">
                        <article class="product__card">
                            <div class="product__card--thumbnail">
                                <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                    <img class="product__card--thumbnail__img product__primary--img display-block" src="assets/img/product/product9.webp" alt="product-img">
                                    <img class="product__card--thumbnail__img product__secondary--img display-block" src="assets/img/product/product10.webp" alt="product-img">
                                </a>
                                <ul class="product__card--action d-flex align-items-center justify-content-center">
                                    <li class="product__card--action__list">
                                        <a class="product__card--action__btn" title="Wishlist" href="wishlist.html">
                    ...
                    <div class="col custom-col-2 mb-30">
                        <article class="product__card">
                            <div class="product__card--thumbnail">
                                <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                    <img class="product__card--thumbnail__img product__primary--img display-block" src="assets/img/product/product11.webp" alt="product-img">
                                    <img class="product__card--thumbnail__img product__secondary--img display-block" src="assets/img/product/product12.webp" alt="product-img">
                                </a>
                                <div class="product__badge">
                                    <span class="product__badge--items sale">SALE</span>
                                </div>
                    ...
                    <div class="col custom-col-2 mb-30">
                        <article class="product__card">
                            <div class="product__card--thumbnail">
                                <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                    <img class="product__card--thumbnail__img product__primary--img display-block" src="assets/img/product/product10.webp" alt="product-img">
                                    <img class="product__card--thumbnail__img product__secondary--img display-block" src="assets/img/product/product9.webp" alt="product-img">
                                </a>
                                <ul class="product__card--action d-flex align-items-center justify-content-center">
                                    <li class="product__card--action__list">
                                        <a class="product__card--action__btn" title="Wishlist" href="wishlist.html">
                        ...
                        <article class="product__card">
                            <div class="product__card--thumbnail product__swiper--column1 swiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                            <img class="product__card--thumbnail__img product__primary--img display-block" src="assets/img/product/product8.webp" alt="product-img">
                                            <img class="product__card--thumbnail__img product__secondary--img display-block" src="assets/img/product/product9.webp" alt="product-img">
                                        </a>
                                        <div class="product__badge">
                                            <span class="product__badge--items sale">SALE</span>
                                    ...
                                    <div class="swiper-slide">
                                        <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                            <img class="product__card--thumbnail__img product__primary--img display-block" src="assets/img/product/product10.webp" alt="product-img">
                                            <img class="product__card--thumbnail__img product__secondary--img display-block" src="assets/img/product/product11.webp" alt="product-img">
                                        </a>
                                        <div class="product__badge">
                                            <span class="product__badge--items sale">SALE</span>
                                        </div>
                    ...
                    <div class="col custom-col-2 mb-30">
                        <article class="product__card">
                            <div class="product__card--thumbnail">
                                <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                    <img class="product__card--thumbnail__img product__primary--img display-block" src="assets/img/product/product12.webp" alt="product-img">
                                    <img class="product__card--thumbnail__img product__secondary--img display-block" src="assets/img/product/product11.webp" alt="product-img">
                                </a>
                                <ul class="product__card--action d-flex align-items-center justify-content-center">
                                    <li class="product__card--action__list">
    ...
    <div class="counterup__section section--padding pt-0" id="funfactId">
        <div class="container">
            <div class="section__heading text-center mb-50">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-7">
                    <div class="contact__content">
                        <div class="section__heading contact__heading mb-30">
                            <h2 class="section__heading--maintitle text__secondary mb-10">Our Contact</h2>
                            <p class="section__heading--desc contact__heading--desc">Beyond more stoic this along goodness this sed wow manatee mongos
                                flusterd impressive man farcrud opened.</p>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="contact__form--list mb-20">
                                            <label>
                                                <input class="contact__form--input" name="firstname" id="input1" placeholder="Your Name" type="text">
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="contact__form--list mb-20">
                                            <label>
                                                <input class="contact__form--input" name="lastname" id="input2" placeholder="Your Email" type="email">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="contact__form--list mb-10">
                                    <textarea class="contact__form--textarea style2"  placeholder="Write Your Message"></textarea>
                                </div>
                                <button class="contact__form--style__btn primary__btn" type="submit">Submit Now</button>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <article class="blog__card">
                            ...
                            <div class="blog__card--content padding__style2">
