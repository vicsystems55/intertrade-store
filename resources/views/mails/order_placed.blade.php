...
<table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="640" style="width:640px;max-width:640px;" data-module="blue-preface-13">
  <!-- blue-preface-13 -->
  <tr>
    <td align="center" bgcolor="#FFFFFF" data-bgcolor="BgColor" class="container-padding">
    ...
    <td align="center" data-bgcolor="BgColor" bgcolor="#FFFFFF">
      ...
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
        ...
        <tr data-element="blue-title" data-label="Titles">
          <td class="center-text" data-text-style="Titles" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:18px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
              <singleline>
                <div mc:edit data-text-edit>
                  Order Number
                </div>
        ...
        <tr data-element="blue-bm-usercode" data-label="User Code">
          <td height="60" style="font-size:60px;line-height:60px;" data-height="Spacing under user code">&nbsp;</td>
        </tr>

        <tr data-element="blue-shipping-details" data-label="Shipping details">
          <td align="center">
            <!-- rwd-col -->
            ...
            <!-- column -->
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
              <tr data-element="blue-content-titles" data-label="Titles">
                <td class="center-text" data-text-style="Titles" align="right" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                    <singleline>
                      <div mc:edit data-text-edit>
                        Shipping details
                      </div>
            ...
            <!-- column -->
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
              <tr data-element="blue-content-paragraph" data-label="Paragraphs">
                <td class="hide-mobile" align="center" width="20" style="width:20px;max-width:20px;border-left: 1px solid #000000;"></td>
                <td class="center-text" data-text-style="Paragraphs" align="left" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:18px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                    <singleline>
                      <div mc:edit data-text-edit>
        ...
        <tr data-element="blue-shipping-details" data-label="Shipping details">
          <td height="20" style="font-size:20px;line-height:20px;" data-height="Spacing under shipping details">&nbsp;</td>
        </tr>

        <tr data-element="blue-estimated-arrival" data-label="Estimated arrival">
          <td align="center">
            <!-- rwd-col -->
            <table border="0" cellpadding="0" cellspacing="0" align="center" class="container-padding" width="100%" style="width:100%;max-width:100%;">
              <tr>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
              <tr data-element="blue-content-paragraph" data-label="Paragraphs">
                ...
                <td class="center-text" data-text-style="Paragraphs" align="left" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:18px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                    <singleline>
                      <div mc:edit data-text-edit>
                        Given name: <strong>{{$data['name']}}</strong><br>
                        {{\Carbon\Carbon::now()->addDays(3)->format('d M, Y')}} – {{\Carbon\Carbon::now()->addDays(6)->format('d M, Y')}}
                      </div>
                    </singleline>
                </td>
              </tr>
...
<table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="640" style="width:640px;max-width:640px;" data-module="blue-title">
  ...
  <tr>
    <td height="5" style="font-size:5px;line-height:5px;" data-height="Spacing bottom">&nbsp;</td>
  </tr>
</table>
<!-- blue-title -->
@foreach ($data['orderItems'] as $item)
<table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="640" style="width:640px;max-width:640px;" data-module="blue-product-1">
    <!-- blue-product-1 -->
    <tr>
      ...
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
        ...
        <tr>
          ...
          <table border="0" cellpadding="0" cellspacing="0" align="center" class="row container-padding" width="90.63%" style="width:90.63%;max-width:90.63%;">
            ...
            <tr>
              <td class="rwd-col" align="center" width="31.03%" style="width:31.03%;max-width:31.03%;">

              <!-- column -->
              <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                <tr data-element="blue-content-picture" data-label="Picture">
                  <td align="center">
                    <img class="auto-width" style="display:block;width:100%;max-width:100%;" data-image-edit data-url data-label="Picture" data-border-radius-default="0,6,36" data-border-radius-custom="Pictures" width="180" src="{{$item->products->img_url}}" border="0" editable="true" alt="picture">
                  </td>
                </tr>
              </table>
              <!-- column -->
          ...
          <td class="rwd-col" align="center" width="3.45%" height="30" style="width:3.45%;max-width:3.45%;height: 30px;">&nbsp;</td>
          <td class="rwd-col" align="center" width="65.52%" style="width:65.52%;max-width:65.52%;">

              <!-- column -->
              <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                <tr data-element="blue-content-titles" data-label="Titles">
                  <td class="center-text" data-text-style="Titles" align="left" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                      <singleline>
                        <div mc:edit data-text-edit>
                          {{$item->products->name}}
                        </div>
                ...
                <tr data-element="blue-content-titles" data-label="Titles">
                  <td height="5" style="font-size:5px;line-height:5px;" data-height="Spacing under titles">&nbsp;</td>
                </tr>
                <tr data-element="blue-content-paragraph" data-label="Paragraphs">
                  <td class="center-text" data-text-style="Paragraphs" align="left" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:16px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                      <singleline>
                        <div mc:edit data-text-edit>
                ...
                <tr data-element="blue-content-paragraph" data-label="Paragraphs">
                  <td height="10" style="font-size:10px;line-height:10px;" data-height="Spacing under paragraphs">&nbsp;</td>
                </tr>
                ...
                <tr data-element="blue-content-option-3" data-label="3rd Option">
                  <td class="center-text" data-text-style="Options" align="left" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:16px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                      <singleline>
                        <div mc:edit data-text-edit>
...
<table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="640" style="width:640px;max-width:640px;" data-module="blue-order-total">
  <!-- blue-order-total -->
  <tr>
    <td align="center" bgcolor="#FFFFFF" data-bgcolor="BgColor" class="container-padding">
...
<table data-inner-table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="inner-table row" width="580" style="width:580px;max-width:580px;">
  ...
  <tr>
    <td align="center" data-bgcolor="BgColor" bgcolor="#FFFFFF">
      <!-- content -->
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
        <tr data-element="blue-payment-method" data-label="Payment method">
          <td align="center">
            <!-- rwd-col -->
            <table border="0" cellpadding="0" cellspacing="0" align="center" class="container-padding" width="100%" style="width:100%;max-width:100%;">
              <tr>
        ...
        <tr data-element="blue-payment-method" data-label="Payment method">
          <td height="10" style="font-size:10px;line-height:10px;" data-height="Spacing under payment method">&nbsp;</td>
        </tr>

        <tr data-element="blue-subtotal" data-label="Subtotal">
          <td align="center">
            <!-- rwd-col -->
            <table border="0" cellpadding="0" cellspacing="0" align="center" class="container-padding" width="100%" style="width:100%;max-width:100%;">
              <tr>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="m-padding-top10" width="100%" style="width:100%;max-width:100%;">
              <tr data-element="blue-content-paragraph" data-label="Paragraphs">
                ...
                <td class="center-text" data-text-style="Paragraphs" align="left" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:18px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                    <singleline>
                      <div mc:edit data-text-edit>
                        N {{number_format($data['total_amount'], 2)}}
                      </div>
                    </singleline>
                </td>
              </tr>
        ...
        <tr data-element="blue-tax" data-label="Tax">
          <td height="30" style="font-size:30px;line-height:30px;" data-height="Spacing under tax">&nbsp;</td>
        </tr>

        <tr data-element="blue-content-total" data-label="Total">
          <td align="center">
            <!-- rwd-col -->
            <table border="0" cellpadding="0" cellspacing="0" align="center" class="container-padding" width="100%" style="width:100%;max-width:100%;">
              <tr>
                <td class="rwd-col" align="center" valign="top" width="49%" style="width:49%;max-width:49%;">
      ...
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="480" style="width:480px;max-width:480px;">
        <tr>
          <td class="center-text" data-text-style="Paragraphs" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:300;font-style:normal;color:#666666;text-decoration:none;letter-spacing:0px;">
            <multiline>
              <div mc:edit data-text-edit>
                2023 vicSystems Technologies Ltd. All Rights Reserved.<br>
                Plot 8, Saburi 1, Dei dei FCT Abuja, Nigeria
              </div>
            </multiline>
          </td>
        </tr>
