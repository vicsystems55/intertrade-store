...
<table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" width="640" style="width:640px;max-width:640px;" data-module="blue-header">
  ...
  <tr>
    <td align="center" class="img-responsive container-padding">
      <img class="auto-width" style="display:block;width:100%;max-width:100%;border:0px;" data-image-edit data-url data-label="Header image" width="640" src="images/header-1.jpg" border="0" editable="true" alt="picture">
    </td>
  </tr>
  <!-- blue-header -->
</table>
      ...
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
        ...
        <tr data-element="blue-paragraph" data-label="Paragraphs">
          <td class="center-text" data-text-style="Paragraphs" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
              <singleline>
                <div mc:edit data-text-edit>
                  Welcome to your new store account! We hope you will enjoy it very much!
                  With your new store account, you will have access to:
                  <h3>Sellers Dashboard</h3>

                  Please do not reply to this email. If you have any questions, please contact our customer service team at 08037835670.
                </div>
              </singleline>
          </td>
        </tr>
  ...
  <tr>
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
      <tr>
        <td align="center" class="img-responsive">
          <img class="auto-width" style="display:block;width:100%;max-width:100%;border:0px;border-radius:100%;" data-image-edit data-url data-border-radius-default="0,6,36" data-border-radius-custom="Picture" data-label="Picture" width="160" src="images/project-1.jpg" border="0" editable="true" alt="picture">
        </td>
      </tr>
    </table>
    <!-- column -->
    ...
    <td class="rwd-col" align="center" width="62.5%" style="width:62.5%;max-width:62.5%;">
      ...
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="100%" style="width:100%;max-width:100%;">
        <tr data-element="blue-basic-message-1-titles" data-label="Titles">
          <td class="center-text" data-text-style="Titles" align="left" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:18px;line-height:24px;font-weight:700;font-style:normal;color:#50C0FF;text-decoration:none;letter-spacing:0px;">
              <singleline>
                <div mc:edit data-text-edit>
                  Setup your store.
                </div>
        ...
        <tr data-element="blue-basic-message-1-button" data-label="Links">
          <td align="center">
            <table border="0" cellpadding="0" cellspacing="0" align="left" class="center-float">
              <tr data-element="blue-basic-message-1-button" data-label="Links">
                <td align="left" class="center-text" data-border-color="Underline border" style="border-bottom: 4px solid #0387EC;">
                  <!-- Links -->
...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="75%" style="width:75%;max-width:75%;">
  <tr>
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
      <tr>
        <td align="center" class="img-responsive">
          <img class="auto-width" style="display:block;width:100%;max-width:100%;border:0px;border-radius:100%;" data-image-edit data-url data-border-radius-default="0,6,36" data-border-radius-custom="Picture" data-label="Picture" width="160" src="images/project-2.jpg" border="0" editable="true" alt="picture">
        </td>
      </tr>
    </table>
    <!-- column -->
...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="75%" style="width:75%;max-width:75%;">
  <tr>
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
      <tr>
        <td align="center" class="img-responsive">
          <img class="auto-width" style="display:block;width:100%;max-width:100%;border:0px;border-radius:100%;" data-image-edit data-url data-border-radius-default="0,6,36" data-border-radius-custom="Picture" data-label="Picture" width="160" src="images/project-3.jpg" border="0" editable="true" alt="picture">
        </td>
      </tr>
    </table>
    <!-- column -->
          ...
          <td class="center-text" data-text-style="Paragraphs" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:300;font-style:normal;color:#666666;text-decoration:none;letter-spacing:0px;">
            <multiline>
              <div mc:edit data-text-edit>
                ...
                Plot 660, Dutse Alhaji, Fct Abuja, Nigeria
              </div>
            </multiline>
          </td>
        </tr>
